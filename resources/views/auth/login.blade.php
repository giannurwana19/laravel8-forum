...
@section('content')
<div class="container">
    <div class="jumbotron bg-primary border" id="tc_jumbotron">
        <div class="card-body">
            <div class="col-md-8 offset-md-2">
                ...
                <div class="create_info">
                    <span class="text-white"><i class="fa fa-info-circle"></i> Lorem Ipsum is simply dummy text of the printing and
