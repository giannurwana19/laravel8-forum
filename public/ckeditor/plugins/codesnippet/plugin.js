...
(function() {
  CKEDITOR.plugins.add("codesnippet", {
    ...
    lang:
      "ar,az,bg,ca,cs,da,de,de-ch,el,en,en-au,en-gb,eo,es,es-mx,et,eu,fa,fi,fr,fr-ca,gl,he,hr,hu,id,it,ja,km,ko,ku,lt,lv,nb,nl,no,oc,pl,pt,pt-br,ro,ru,sk,sl,sq,sr,sr-latn,sv,th,tr,tt,ug,uk,vi,zh,zh-cn", // %REMOVE_LINE_CORE%
      ...
      if (!editor._.codesnippet.highlighter) {
        var hljsHighlighter = new CKEDITOR.plugins.codesnippet.highlighter({
          ...
          highlighter: function(code, language, callback) {
            var highlighted = this.hljs.highlightAuto(
              code,
  ...
  function registerWidget(editor) {
    ...
    editor.widgets.add("codeSnippet", {
          ...
          callback = function(formatted) {
            ...
            that.parts.code.setHtml(
              editor.plugins.codesnippet.isSupportedEnvironment()
                ? formatted
                : formatted.replace(newLineRegex, "<br>")
            );
          };
      ...
      upcast: function(el, data) {
        ...
        if (matchResult) data.lang = matchResult[1];
